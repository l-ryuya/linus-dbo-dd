...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('service_translations', function (Blueprint $table) {
            ...
            // システム識別子
            $table->unsignedBigInteger('service_translation_id')
                ->primary()
                ->comment('内部用連番 PK');
        ...
        // ID列にIDENTITYを追加する
        DB::statement("ALTER TABLE service_translations ALTER COLUMN service_translation_id ADD GENERATED BY DEFAULT AS IDENTITY");
        // インデックス: 言語コードによる検索性能向上
