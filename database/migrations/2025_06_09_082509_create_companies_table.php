...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('companies', function (Blueprint $table) {
            ...
            // ビジネス識別子
            $table->unsignedBigInteger('company_code_seq')
                ->comment('法人コード生成用カウンタ');
            $table->text('company_code')
                ->storedAs("'CO-' || lpad(company_code_seq::text, 6, '0')")
                ->comment('法人コード（外部公開用）');
        ...
        DB::statement("ALTER TABLE companies ALTER COLUMN company_code_seq ADD GENERATED ALWAYS AS IDENTITY");
        // ユニーク制約
