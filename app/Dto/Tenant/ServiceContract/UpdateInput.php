...
final readonly class UpdateInput
{
    ...
    public static function fromRequest(array $data): self
    {
        return new self(
            ...
            customerContactUserEmail: $data['customerContactUserEmail'],
            ...
            customerContractUserEmail: $data['customerContractUserEmail'],
            ...
            customerPaymentUserEmail: $data['customerPaymentUserEmail'],
            serviceRepUserPublicId: $data['serviceRepUserPublicId'],
            serviceMgrUserPublicId: $data['serviceMgrUserPublicId'],
