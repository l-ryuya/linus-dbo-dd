...
class ShowAction
{
    ...
    public function __invoke(
        ...
        return ServiceContract::select([
            ...
            'service_contracts.customer_contact_user_mail',
            ...
            'service_contracts.customer_contract_user_mail',
            ...
            'service_contracts.service_rep_user_option_id',
            'service_mgr_user.user_name AS service_mgr_user_name',
            'service_contracts.service_mgr_user_option_id',
