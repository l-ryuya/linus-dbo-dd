...
class ShowAction
{
    ...
    public function __invoke(
        ...
        return ServiceContract::select([
            ...
            'service_contracts.quotation_name',
            'service_contracts.quotation_number',
            'service_contracts.quotation_date',
            'service_contracts.proposal_name',
            'service_contracts.proposal_number',
            'service_contracts.proposal_date',
